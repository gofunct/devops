...
- [Alfred Workflows Study Guide](#alfred-workflows-study-guide)
    - [Install](#install)
    - [Workflows](#workflows)
        - [Caffeinate (v3.03.0) ~ Download](#caffeinate-v3030--download)
        - [Colors (v2.0.2) ~ Download](#colors-v202--download)
        - [DevDocs (v1.2.0) ~ Download](#devdocs-v120--download)
        - [Domainr (v1.2.1) ~ Download](#domainr-v121--download)
        - [Emoji (v1.5.0) ~ Download](#emoji-v150--download)
        - [Encode/Decode (v1.8.0) ~ Download](#encodedecode-v180--download)
        - [Faker (v1.0.0) ~ Download](#faker-v100--download)
        - [GitHub (v1.6.0) ~ Download](#github-v160--download)
        - [IP Address (v1.2.0) ~ Download](#ip-address-v120--download)
        - [Kill Process (v1.2.0) ~ Download](#kill-process-v120--download)
        - [Package Managers (v3.16.0) ~ Download](#package-managers-v3160--download)
        - [Source Tree (v1.2.0) ~ Download](#source-tree-v120--download)
        - [Stack Overflow (v1.0.1) ~ Download](#stack-overflow-v101--download)
        - [Sublime Text (v1.1.0) ~ Download](#sublime-text-v110--download)
        - [Terminal → Finder (v1.6.0) ~ Download](#terminal-%E2%86%92-finder-v160--download)
    - [](#)
        - [TimeZones (v1.9.0) ~ Download](#timezones-v190--download)
        - [VirtualBox (v2.0.1) ~ Download](#virtualbox-v201--download)
...
number, etc ~ *by [@groenewege](https://github.com/groenewege).*
...
Generate fake data such as name, email address, credit card 
